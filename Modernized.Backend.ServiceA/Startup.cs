...
using Modernized.Backend.ServiceA.Services;

namespace Modernized.Backend.ServiceA
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Modernized.Backend.ServiceA", Version = "v1" });
            });
            ...
            var _sharedCookieName = Configuration["ServiceA:SharedCookieName"];
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Modernized.Backend.ServiceA v1"));
            }
            ...
            #region [Custom]: Add the middleware.
            // FYI: The Authentication is responsible for providing the ClaimsPrincipal for authorization to make permission decisions against.
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapHealthChecks(Configuration["ServiceA:HealthCheckUrl"]);
                #endregion
